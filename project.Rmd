...
View(train)
write.csv(train,"https://github.com/saludwig26/Data-science-Team-5-1\\train.csv", row.names = TRUE)
#Similarly, to create the testing dataset,
test=subset(umsatzdaten, umsatzdaten$spl==FALSE) 
View(test)
write.csv(train,"https://github.com/saludwig26/Data-science-Team-5-1\\test.csv", row.names = TRUE)
