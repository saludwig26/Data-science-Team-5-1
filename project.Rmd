...
group_by(Month) %>% 
 ...
 View(umsatzdaten_y13)
  ...
  df_final_plot2_sz1 <-    
    group_by(df_final_sz1,cluster_sz1) %>% 
    summarise(TPAD_avg = mean (TPAD))
  
  View(df_final_plot2_sz1)
  
  
  df_final_plot3_sz1 <-    
    group_by(df_final_sz1,cluster_sz1) %>% 
    summarise(TCAL_avg = mean (TCAL))
  
  View(df_final_plot3_sz1)
  
  df_final_plot4_sz1 <-    
    group_by(df_final_sz1,cluster_sz1) %>% 
    summarise(Sum_Doc_Rel_a
...
View(umsatzdaten) 
umsatzdaten$Wettercode <- !is.na(umsatzdaten$Wettercode)
