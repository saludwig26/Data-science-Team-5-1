...
umsatzdaten$temperatur <- cut(umsatzdaten$Temperatur, c(-20,-10,0,10,20,30,40) )

#UMSATZ ~ TEMPERATUR
ggplot(umsatzdaten) +
  facet_wrap(~Warengruppe) +
  geom_point(aes(x = temperatur, y = Umsatz, colour=holiday), size=0.1) + theme(axis.text.x = element_text(angle = 90, hjust = 1))
