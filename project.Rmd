...
```{r}
isHoliday=
>>>>>>> 6aec528ec1bed185bd23b0b89179cd2cb288529c
```
Feiertag am Wochenende
```{r}
isHoliday=
...
View(umsatzdaten$Windgeschwindigkeit)
<<<<<<< HEAD
=======
...
```{r}
rbind(glance(mod1), glance(mod2), glance(mod3), glance(mod4), glance(mod5), glance(mod6), glance(mod7), glance(mod8))
```
